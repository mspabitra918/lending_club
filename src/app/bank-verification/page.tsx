...
import { ACCOUNT_TYPES, SITE_NAME } from "@/lib/constants";
              ...
              <div className="grid lg:grid-cols-2">
                ...
                <div className="bg-cta-gradient p-10 lg:p-14 text-white">
                  ...
                  <div className="mt-10 p-5 bg-white/10 rounded-xl">
                    <h4 className="font-semibold mb-2">Where to Find Your Info</h4>
                    <p className="text-white/70 text-sm">
                      Your routing and account numbers can be found at the
                      bottom of your checks, on your bank statements, or in
                      your online banking portal. The routing number is 9
                      digits and the account number varies by bank.
                    </p>
                  </div>
                </div>
                  ...
                  {submitResult?.success ? (
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                      ...
                      <button
                        ...
                        className="w-full bg-primary hover:bg-primary-dark text-white font-bold py-4 rounded-xl transition-all hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                      >
                        {isSubmitting ? (
                          <>
